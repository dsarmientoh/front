function autoInicioCategoria(){
    ...
    $.ajax({
        url:"http://193.123.116.95:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function cargarDatosMotorbike(id) {
    $.ajax({
        dataType: 'json',
        url:"http://193.123.116.95:8080/api/Motorbike/"+id,
        type: 'GET',
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
       alert("Todos los campos son obligatorios")
            ...
            $.ajax({
                ...
                url:"http://193.123.116.95:8080/api/Motorbike/save",
                data: dataToSend,
                datatype: 'json',
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://193.123.116.95:8080/api/Motorbike/"+idElemento,
            type: 'DELETE',
            contentType: "application/JSON",
            success: function (response) {
                console.log(response);
...
function actualizar(idElemento) {
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://193.123.116.95:8080/api/Motorbike/update",
            type: "PUT",
